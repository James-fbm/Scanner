...
import com.example.scanner.ui.viewmodel.CollectionTopSearchBarUiModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CollectionTopNavigator (
    ...
    Row(
        ...
        SearchBar(
            ...
            active = collectionTopSearchBarUiModel.activeState,
            onActiveChange = {
            ...
            leadingIcon = {
                if (!collectionTopSearchBarUiModel.activeState) {
            ...
            query = collectionTopSearchBarUiModel.inputQuery
        ) {
